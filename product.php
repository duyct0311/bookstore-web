...
<section class="product" >
    <div class="container" >
        ...
        <div class="product-content row">
            <?php
            $sql_product="select * from product where id='$book_id'";
            ?>
...
<!--                                </div>-->
            ...
            <div class="product-content-right">
                    ...
                    <div class="product-content-right-product-auther row">
                        <p style="flex:1"><span style="font-weight: bold">Author:</span> <?php echo $row['author_name'] ?></p>
                        <p style="flex:2"><span style="font-weight: bold;">Publication date:</span> <?php echo $row['publication_date'] ?></p>
                     </div>
                    <div class="product-content-right-product-auther row">
                        <p style="flex:1"><span style="font-weight: bold">Category:</span> <?php echo $row['category'] ?></p>
                        <p style="flex:2"><span style="font-weight: bold">Publisher_name:</span> <?php echo $row['publisher_name'] ?></p>
                    </div>
                    ...
                    <div class="product-content-right-bottom-content-big">
                        ...
                        <div class="product-content-right-bottom-content">
                            <div class="product-content-right-bottom-content-detail" style="width: 80%">
                                ...
                                Publisher: <?php echo $row['publisher_name'] ?> <br>
                                Publish Date: <?php echo $row['publication_date'] ?> <br>
...
<section class="product-more" style="padding-left: 100px;">
    ...
    <div class="product-content row">
        <?php
            $count_book='select id from product';
             $count_book1=mysqli_query($conn,$count_book);
             $arr_r=array();
             $i=1;
             while ($count_book2=mysqli_fetch_array($count_book1)){
                 if($count_book2['id']!=$book_id) {
                     $arr_r[$i] = $count_book2['id'];
                     $i++;
                 }
               }
               shuffle($arr_r);
