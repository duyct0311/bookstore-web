...
//            }
    ...
    $query = "insert into product (title,price,publication_date,quantity,publisher_name,author_name,thumbnail,category,description)
...
if($result)
{
    header("location:manger_book.php");
}
else
{
