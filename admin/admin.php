...
$sql_product="select * from product where title like '%$search%' order by id desc limit $so_sach_tren_1_trang   offset $bo_qua ";
$result=mysqli_query($conn,$sql_product );
...
<!--                </div>-->
        ...
        <div class="activity">
            <div class="title">
                ...
                <span class="text">Recent Activity Book</span>
            </div>
