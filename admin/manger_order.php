...
<!--                    </div>-->
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Tên sách" name="title" required="" value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="material">Số điện thoại  </label>
                        <input type="text" class="form-control" id="material" placeholder="Tác giả" name="author_name" required="" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="publisher_name"> Địa chỉ</label>
                        <input type="text" class="form-control" id="publisher_name" placeholder="Nhà xuất bản" name="publisher_name" required="" value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="publication_date">Tổng tiền </label>
                        <input type="number" class="form-control" id="entry" placeholder="Ngày xuất bản" name="publication_date" required="" value="">
                    </div>
<!--                    <div class="form-group col-md-4">-->
...
<!--                    </div>-->
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="amount">Sách </label>
                        <input type="text" class="form-control" id="amount" placeholder="Số lượng" name="" required="" value="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="amount">Số lượng </label>
                        <input type="number" class="form-control" id="amount" placeholder="Giá tiền" name="quantity" required="" value="">
                    </div>

                </div>
                <div class="form-group col-md-4">
                    <label for="publication_date">Tổng tiền </label>
                    <input type="number" class="form-control" id="entry" placeholder="Tổng tiền" name="publication_date" required="" value="">
                </div>
